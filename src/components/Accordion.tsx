      ...
      <div className='grid divide-y divide-neutral-200 max-w-xl mx-auto mt-8'>
        <div className='py-5'>
          <details className='group'>
            <summary className='flex justify-between items-center font-medium cursor-pointer list-none tour-step-2'>
              <span className='text-black'> What is a SAAS platform?</span>
        ...
        <div className='py-5'>
          <details className='group'>
            <summary className='tour-step-3 flex justify-between items-center font-medium cursor-pointer list-none'>
              <span className='text-black'> How does billing work?</span>
              <span className='transition group-open:rotate-180'>
                <svg
                  fill='none'
                  height='24'
        ...
        <div className='py-5'>
          <details className='group'>
            <summary className='tour-step-4 flex justify-between items-center font-medium cursor-pointer list-none'>
        ...
        <div className='py-5'>
          <details className='group'>
            <summary className='tour-step-5 flex justify-between items-center font-medium cursor-pointer list-none'>
              <span className='text-black'>
        ...
        <div className='py-5'>
          <details className='group'>
            <summary className='flex justify-between items-center font-medium cursor-pointer list-none'>
              <span className='text-black'>How do I access documentation?</span>
              <span className='transition group-open:rotate-180'>
                <svg
                  fill='none'
                  height='24'
            ...
            <p className='text-neutral-600 mt-3 group-open:animate-fadeIn'>
              Documentation is available on the company website and can be
        ...
        <div className='py-5'>
          <details className='group'>
            ...
            <p className='text-neutral-600 mt-3 group-open:animate-fadeIn'>
              ...
              you can contact the company support team by submitting a support
        ...
        <div className='py-5'>
          <details className='group'>
            ...
            <p className='text-neutral-600 mt-3 group-open:animate-fadeIn'>
              ...
              for the company newsletter or follow it on social media.
            </p>
          </details>
        </div>
        <div className='py-5'>
